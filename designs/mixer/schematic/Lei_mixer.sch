...
N 990 -880 990 -830 {lab=VDD}
N 300 -880 300 -830 {lab=VDD}
...
N 990 -770 990 -750 {lab=#net3}
N 300 -770 300 -750 {lab=#net4}
...
C {lab_wire.sym} 300 -890 0 0 {name=p6 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 990 -900 0 0 {name=p18 sig_type=std_logic lab=VDD}
...
device=resistor
m=1}
C {ammeter.sym} 300 -800 0 0 {name=V_i_ifm savecurrent=true spice_ignore=0}
C {ammeter.sym} 990 -800 0 0 {name=V_i_ifp savecurrent=true spice_ignore=0}
