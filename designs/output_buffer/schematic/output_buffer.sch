...
N 750 -470 750 -430 {lab=#net1
}
N 1060 -460 1060 -430 {lab=Vout
}
N 750 -600 1020 -600 {lab=VB
}
N 750 -600 750 -580 {lab=VB
}
N 1060 -670 1060 -630 {lab=VDD
}
N 750 -640 750 -600 {lab=VB
}
...
N 920 -600 920 -520 {lab=VB
}
N 710 -210 720 -210 {lab=#net2
}
...
N 1060 -570 1060 -540 {lab=#net3
}
N 1060 -480 1060 -460 {lab=Vout
}
N 920 -460 920 -410 {lab=VA
}
N 1060 -330 1060 -310 {lab=#net4
}
...
N 870 -210 1020 -210 {lab=VA
}
N 620 -770 660 -770 {lab=VDD
}
N 660 -830 660 -770 {lab=VDD
}
N 620 -740 620 -310 {lab=#net2
}
...
N 660 -210 710 -210 {lab=#net2
}
N 720 -210 730 -210 {lab=#net2
}
N 730 -210 740 -210 {lab=#net2
}
N 700 -270 700 -210 {lab=#net2
}
N 620 -270 700 -270 {lab=#net2
}
...
N 750 -740 750 -700 {lab=VB
}
N 1010 -430 1060 -430 {lab=Vout
}
N 750 -430 950 -430 {lab=#net1
}
N 750 -700 750 -640 {lab=VB
}
N 620 -310 620 -240 {lab=#net2}
N 1060 -310 1060 -240 {lab=#net4}
N 770 -270 770 -250 {lab=#net2}
N 700 -270 770 -270 {lab=#net2}
N 770 -210 770 -150 {lab=VSS}
N 920 -410 920 -210 {lab=VA}
N 800 -210 810 -210 {lab=#net5}
N 800 -270 800 -210 {lab=#net5}
N 800 -270 840 -270 {lab=#net5}
N 840 -270 840 -250 {lab=#net5}
N 840 -210 840 -150 {lab=VSS}
N 730 -430 750 -430 {lab=#net1}
